...
var SellerBudgetHandler = /** @class */ (function (_super) {
    __extends(SellerBudgetHandler, _super);
    function SellerBudgetHandler() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SellerBudgetHandler.prototype.handle = function (budget) {
        if (budget.getValue() <= 500) {
            budget.approve();
        }
        return _super.prototype.handle.call(this, budget);
    };
    return SellerBudgetHandler;
